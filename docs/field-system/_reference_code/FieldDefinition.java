...
public record FieldDefinition(
        ...
        // External Influences (Phase 1)
        @Nullable Map<String, BindingConfig> bindings,
        @Nullable List<TriggerConfig> triggers,
    ...
    public FieldDefinition {
        ...
        triggers = triggers != null ? List.copyOf(triggers) : null;
        bindings = bindings != null ? Map.copyOf(bindings) : null;
     ...
     */
    // TODO: Implement when ColorTheme is available
    ...
    public static class Builder {
        ...
        private Map<String, BindingConfig> bindings = null;
        ...
        public Builder bindings(Map<String, BindingConfig> bindings) {
            this.bindings = bindings;
            return this;
        }
        
        public Builder triggers(List<TriggerConfig> triggers) {
            this.triggers = triggers;
            return this;
        }
        
        public Builder lifecycle(LifecycleConfig lifecycle) {
        ...
        public FieldDefinition build() {
            ...
            return new FieldDefinition(id, type, baseRadius, themeId, layers, 
                                       ...
                                       null, null, null); // TODO: parse bindings, triggers, lifecycle from JSON
        }
    }
    ...
    public JsonObject toJson() {
        ...
        // Prediction
        if (prediction != null) {
            // json.add("prediction", prediction.toJson()); // TODO: add toJson to PredictionConfig
        }
        
        // Beam
        if (beam != null && beam.enabled()) {
            // json.add("beam", beam.toJson()); // TODO: use BeamConfig.toJson()
        }
