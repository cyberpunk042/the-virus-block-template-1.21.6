...
public record ForceProfile(
	...
	public static ForceProfile defaultsPull() {
	...
	public static ForceProfile defaultsPush() {
		return new ForceProfile(
	...
	public static ForceProfile vortexPull() {
		return new ForceProfile(
	...
	public static ForceProfile shockPush() {
		return new ForceProfile(
